...
class MailingListTest extends \PHPUnit_Framework_TestCase
{
    public function testSetPromotionName()
    {
        ...
        $this->assertInstanceOf('\MadMimi\Options\Mail\MailingList', $options->setPromotionName('a promotion name'));
    ...
    {
        $options = new MailingList();
        $this->assertInstanceOf('\MadMimi\Options\Mail\MailingList', $options->setSubject('a subject'));
    ...
    {
        $options = new MailingList();
        $this->assertInstanceOf('\MadMimi\Options\Mail\MailingList', $options->setFrom('from@email.com'));
    ...
    {
        $options = new MailingList();
        $this->assertInstanceOf('\MadMimi\Options\Mail\MailingList', $options->setPlaceholderValues(['test'=>'first', 'test2'=>'second']));
    ...
    {
        $options = new MailingList();
        $this->assertInstanceOf('\MadMimi\Options\Mail\MailingList', $options->setHTML('<blink>Yeah</blink>'));
    ...
    {
        $options = new MailingList();
        $this->assertInstanceOf('\MadMimi\Options\Mail\MailingList', $options->setText('I am an email!'));
    ...
    {
        $options = new MailingList();
        $this->assertInstanceOf('\MadMimi\Options\Mail\MailingList', $options->setLists(['first list', "Aaron's List", '"fake" list']));
    ...
    {
        $options = new MailingList();
        $this->assertInstanceOf('\MadMimi\Options\Mail\MailingList', $options->setMergeData(['merge', 'data']));
